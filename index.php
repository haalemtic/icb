...
<head>
    <meta charset="utf-8">
    <title>ICB sarl CABINET D'EXPERTISE INDUSTRIELLE ET D'ASSURANCES</title>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/caroussel-4.jpg" alt="Carousel Image">
                ...
                <div class="carousel-item">
                    <img src="img/caroussel-5.jpg" alt="Carousel Image">
                    <div class="carousel-caption">
                ...
                <div class="carousel-item">
                    <img src="img/caroussel-6.jpg" alt="Carousel Image">
                    <div class="carousel-caption">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="section-header text-left">
                            <p>Bienvenue à ICB sarl</p>
                            <h2>26 Ans D'Experience</h2>
                        </div>
        ...
        <div class="team">
            <div class="container">
                <div class="section-header text-center">
                    <p>Notre équipe</p>
                    <h2>Découvrer nos Ingénieurs</h2>
                </div>
                <div class="row">
